...
class SafetyTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "SafetyCell", for: indexPath) as! DisplayTableViewCell
    ...
    func loadURL() {
        let url = self.CurrentPage == 1 ? URL(string: "https://itsc.nju.edu.cn/aqtg/list.htm")! : URL(string: "https://itsc.nju.edu.cn/aqtg/list\(self.CurrentPage).htm")!
    ...
    */
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        // Get the new view controller using segue.destination.
        // Pass the selected object to the new view controller.
        let SafetyViewController = segue.destination as! ItemViewController
        let cell = sender as! DisplayTableViewCell
        SafetyViewController.Url = Dictcell[tableView.indexPath(for: cell)!.row].URL
        SafetyViewController.style = "Safety"
    }
